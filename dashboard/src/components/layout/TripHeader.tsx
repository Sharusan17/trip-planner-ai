    ...
    <header className="bg-white border border-parchment-dark rounded-2xl px-5 py-4 mb-6 shadow-[var(--shadow-card)]">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          {countdown && (
            <span className={`flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full font-body ${
              countdown.active
                ? 'bg-emerald-50 text-emerald-700'
                : 'bg-parchment text-ink-light border border-parchment-dark'
            }`}>
